export default function Footer() {
  ...
  return (
    <footer id="contact" className="py-16 sm:py-24 bg-gray-50 px-4 sm:px-6">
      <div className="max-w-2xl mx-auto">
        ...
        <a
          href={`mailto:${email}`}
          className="inline-block text-slate-700 border-b border-slate-400 pb-0.5 text-sm hover:text-slate-900 hover:border-slate-700 transition-colors duration-200 break-all"
        >
          {email}
        </a>
